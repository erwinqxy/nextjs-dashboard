...
// server functions. These server functions can then be imported into Client and
// Server components, making them extremely versatile.

// You can also write Server Actions directly inside Server Components
// by adding "use server" inside the action. But for this course,
// we'll keep them all organized in a separate file.
